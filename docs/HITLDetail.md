...
**TaskInstance** | [**TaskInstanceResponse**](TaskInstanceResponse.md) |  | 
...
`func (o *HITLDetail) SetBodyNil(b bool)`
...
`func (o *HITLDetail) SetDefaultsNil(b bool)`

 SetDefaultsNil sets the value for Defaults to be an explicit nil

### UnsetDefaults
`func (o *HITLDetail) UnsetDefaults()`
...
`func (o *HITLDetail) SetRespondedByUserNil(b bool)`
...
`func (o *HITLDetail) SetRespondedAtNil(b bool)`
...
`func (o *HITLDetail) SetChosenOptionsNil(b bool)`

 SetChosenOptionsNil sets the value for ChosenOptions to be an explicit nil

### UnsetChosenOptions
`func (o *HITLDetail) UnsetChosenOptions()`
