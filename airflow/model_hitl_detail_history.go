...
// checks if the HITLDetailHistory type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HITLDetailHistory{}
...
type _HITLDetailHistory HITLDetailHistory
...
func (o *HITLDetailHistory) SetBodyNil() {
	o.Body.Set(nil)
}
...
func (o *HITLDetailHistory) SetRespondedByUserNil() {
...
func (o *HITLDetailHistory) SetRespondedAtNil() {
...
func (o HITLDetailHistory) MarshalJSON() ([]byte, error) {
...
func (o HITLDetailHistory) ToMap() (map[string]interface{}, error) {
...
func (o *HITLDetailHistory) UnmarshalJSON(data []byte) (err error) {
	...
	varHITLDetailHistory := _HITLDetailHistory{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varHITLDetailHistory)

	if err != nil {
		return err
	}

	*o = HITLDetailHistory(varHITLDetailHistory)

	return err
}

type NullableHITLDetailHistory struct {
	value *HITLDetailHistory
	isSet bool
}

func (v NullableHITLDetailHistory) Get() *HITLDetailHistory {
	return v.value
}

func (v *NullableHITLDetailHistory) Set(val *HITLDetailHistory) {
	v.value = val
	v.isSet = true
}

func (v NullableHITLDetailHistory) IsSet() bool {
	return v.isSet
}

func (v *NullableHITLDetailHistory) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHITLDetailHistory(val *HITLDetailHistory) *NullableHITLDetailHistory {
	return &NullableHITLDetailHistory{value: val, isSet: true}
}

func (v NullableHITLDetailHistory) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHITLDetailHistory) UnmarshalJSON(src []byte) error {
	v.isSet = true
