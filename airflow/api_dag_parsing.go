...
/*
ReparseDagFile Reparse Dag File
...
func (a *DAGParsingAPIService) ReparseDagFileExecute(r ApiReparseDagFileRequest) (interface{}, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DAGParsingAPIService.ReparseDagFile")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/parseDagFile/{file_token}"
