...
// checks if the XComResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &XComResponse{}
...
type _XComResponse XComResponse
...
func (o XComResponse) MarshalJSON() ([]byte, error) {
...
func (o XComResponse) ToMap() (map[string]interface{}, error) {
...
func (o *XComResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varXComResponse := _XComResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varXComResponse)

	if err != nil {
		return err
	}

	*o = XComResponse(varXComResponse)

	return err
}

type NullableXComResponse struct {
	value *XComResponse
	isSet bool
}

func (v NullableXComResponse) Get() *XComResponse {
	return v.value
}

func (v *NullableXComResponse) Set(val *XComResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableXComResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableXComResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableXComResponse(val *XComResponse) *NullableXComResponse {
	return &NullableXComResponse{value: val, isSet: true}
}

func (v NullableXComResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableXComResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
