...
func (a *DagSourceAPIService) GetDagSourceExecute(r ApiGetDagSourceRequest) (*DAGSourceResponse, *http.Response, error) {
	var (
		...
		formFiles            []formFile
		localVarReturnValue  *DAGSourceResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DagSourceAPIService.GetDagSource")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/dagSources/{dag_id}"
