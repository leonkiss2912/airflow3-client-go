...
func (a *MonitorAPIService) GetHealthExecute(r MonitorAPIGetHealthRequest) (*HealthInfoResponse, *http.Response, error) {
	var (
		...
		formFiles            []formFile
		localVarReturnValue  *HealthInfoResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MonitorAPIService.GetHealth")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/monitor/health"
